   ...
   <p style={{fontSize:"15px" , fontFamily:"sans-serif"}}>112 Records found.</p>
     ...
     <Stack direction='horizontal' gap={3} style={{marginLeft:"auto"}}>
       ...
       <i class="bi bi-search"></i>
        <Button style={{backgroundColor:"white" , color:"black" ,marginLeft:"30px" , border:"transparent" , fontSize:"18px"}}><i class="bi bi-arrow-clockwise"></i></Button>
        <Button style={{width:"150px" , backgroundColor:"green" , border:"none"}}>Add New</Button>
     </Stack>
   </Stack>
    ...
    <Table striped bordered hover>
      <thead>
        <tr>
          <th><Form.Check type='checkbox' disabled style={{width:"20px" ,height:"20px",margin:"auto"}}/></th>
          <th>Form Details</th>
          <th>Customer Name</th>
          <th>Email</th>
          <th>Phone</th>
          <th>Please rate the quality of the service you recieved from the host</th>
          <th>Please</th>
        </tr>
      </thead>
      <tbody>
